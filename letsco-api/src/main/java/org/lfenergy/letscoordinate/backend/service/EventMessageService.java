    ...
    private Set<String> extractDatesFromEventMessageDto(EventMessageDto eventMessageDto) {
        ...
        if (headerDto != null) {
            ...
            if (headerDto.getProperties() != null && headerDto.getProperties().getBusinessDataIdentifier() != null) {
                ...
                if (headerDto.getProperties().getBusinessDataIdentifier().getBusinessDayTo().isPresent())
                    timestamps.add(headerDto.getProperties().getBusinessDataIdentifier().getBusinessDayTo().get().toString());
            }
        }
